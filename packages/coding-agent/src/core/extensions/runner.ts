...
import type { ImageContent, Model } from "@boxiaolanya2008/pi-ai";
...
export class ExtensionRunner {
	...
	bindCore(actions: ExtensionActions, contextActions: ExtensionContextActions): void {
		...
		this.runtime.registerProvider = () => {
			console.warn("registerProvider is disabled. Only the user-configured model is used.");
		};
		this.runtime.unregisterProvider = () => {
			console.warn("unregisterProvider is disabled.");
		};
	}
